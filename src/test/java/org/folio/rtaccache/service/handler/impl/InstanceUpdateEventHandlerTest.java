...
class InstanceUpdateEventHandlerTest {
  ...
  @Test
  void instanceUpdate_noAction_whenInstanceFormatIdsEmpty() {
    var instance = new Instance().id(UUID.randomUUID().toString()).instanceFormatIds(List.of());
    ...
    verifyNoInteractions(rtacHoldingBulkRepository);
  }
