...
public class KafkaMessageListener {
  ...
  /**
   * A tombstone (null value) is a legitimate kafka record that carries no event to handle. Every listener below
   * dereferences the value to resolve the tenant, so it has to be filtered out first.
   */
